...
import InternalItem from "../InternalItem/InternalItem";
...
const ItemPlaylist = (props) => {
    ...
    useEffect(() => {
        expandRef.current.addEventListener('click', () => {
            for (let i = 0; i < document.getElementsByClassName('dv_ItemPlaylist').length; i++) {
                if (document.getElementsByClassName('dv_ItemPlaylist')[i].classList[1] === 'open') {
                    document.getElementsByClassName('dv_ItemPlaylist')[i].classList.remove('open')
                }
            }
    ...
    return (
        <div
            className="dv_ItemPlaylist"
            ref={itemRef}
            style={{ background: props.background }}>
            <div className="dv_ItemContent">
                <img className='img_coverMusic' src={props.coverMusic}/>
